...
function Yaratish() {
  ...
  let card = statistics.map((e) => {
    return `
     <div class="number hover:bg-[#f5f5f5] hover:translate-y-2 cursor-pointer transition-all duration-200 ease-in-out border-collapse border-[1px] border-[#E0E0E0] rounded-[8px] p-[20px]">
